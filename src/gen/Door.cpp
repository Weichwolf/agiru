...
constexpr std::array<std::pair<std::string_view, std::string_view>, 136> kElsewhere{{
    ...
    {"dotnet::UriBuilder", "dotnet/Uri.h"},
    ...
    {"ForeignImplementation", "runtime/Implementation.h"},
    {"FindImplementation", "runtime/Implementation.h"},
    {"CloneForeign", "runtime/Implementation.h"},
    {"RegisterForeignImplementation", "runtime/Implementation.h"},
    ...
    {"dotnet::Regex", "dotnet/Regex.h"},
    {"dotnet::RegexOptions", "dotnet/Regex.h"},
    {"dotnet::Match", "dotnet/Regex.h"},
    {"dotnet::Group", "dotnet/Regex.h"},
    {"dotnet::Capture", "dotnet/Regex.h"},
    {"dotnet::MatchCollection", "dotnet/Regex.h"},
    {"dotnet::GroupCollection", "dotnet/Regex.h"},
    {"dotnet::CaptureCollection", "dotnet/Regex.h"},
    {"dotnet::Array", "dotnet/Regex.h"},
    {"dotnet::TimeSpan", "dotnet/TimeSpan.h"},
    {"dotnet::NavUserAccountHelper", "dotnet/NavUserAccountHelper.h"},
    {"dotnet::XmlReader", "dotnet/XmlReader.h"},
    {"dotnet::XmlTextReader", "dotnet/XmlReader.h"},
    {"dotnet::XmlReaderSettings", "dotnet/XmlReader.h"},
    {"dotnet::XmlNodeType", "dotnet/XmlReader.h"},
    {"dotnet::DtdProcessing", "dotnet/XmlReader.h"},
    {"dotnet::XmlUrlResolver", "dotnet/XmlReader.h"},
    {"dotnet::NetCredentialCache", "dotnet/XmlReader.h"},
    {"dotnet::StringReader", "dotnet/XmlReader.h"},
    {"dotnet::ArrayList", "dotnet/Generic.h"},
