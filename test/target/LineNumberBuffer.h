...
public:
  ...
  static constexpr std::array kKey1{FieldNumber::OldLineNumber};
};

inline constexpr std::array kLineNumberBufferFields{
...
inline constexpr std::array kLineNumberBufferKeys{
